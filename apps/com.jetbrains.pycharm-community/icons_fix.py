...
def do_extra(app):
    ...
    shutil.copy("opt/apps/" + app_id + "/files/bin/pycharm.svg",
                    "opt/apps/" + app_id + "/entries/icons/hicolor/scable/apps/com.jetbrains.pycharm-community.svg")
    shutil.copy("opt/apps/" + app_id + "/files/bin/pycharm.png",
                    "opt/apps/" + app_id + "/entries/icons/hicolor/128x128/apps/com.jetbrains.pycharm-community.png")