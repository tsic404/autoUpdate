...
def do_extra(app):
    ...
    shutil.copy("opt/apps/" + app_id + "/files/bin/idea.svg",
                    "opt/apps/" + app_id + "/entries/icons/hicolor/scable/apps/com.jetbrains.intellij-idea-edu.svg")
    shutil.copy("opt/apps/" + app_id + "/files/bin/idea.png",
                    "opt/apps/" + app_id + "/entries/icons/hicolor/128x128/apps/com.jetbrains.intellij-idea-edu.png")