...
def do_extra(app):
    ...
    copy(join(app.origin_extracted_path, "lib/systemd/system/veyon.service"),"opt/apps/" + appid + "/files/lib/systemd/system/veyon.service")
    popen("ln -sf ../../../../opt/apps/" + appid + "/files/lib/systemd/system/veyon.service usr/lib/systemd/system/veyon.service").read()
